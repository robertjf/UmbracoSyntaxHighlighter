    ...
    tinymce.create('tinymce.plugins.SyntaxHighlighterPlugin', {
        ...
        init: function (ed, url) {
            ...
            ed.addCommand('mceSyntaxHighlighter', function () {
                dialogService.open({
                    template: '/App_Plugins/SyntaxHighlighter/Backoffice/Dialogs/InsertCode.html',
        ...
        getInfo: function () {
            return {
                longname: 'SyntaxHighlighter Plugin',
                author: 'Robert Foster',
                authorurl: 'https://youritteam.com.au',
                infourl: 'none',
                version: "1.0"
            };
        }
